(function () {
  var pushcrewConfig = {
    companyName: 'Min JS',
    hash: 'b16b55bf1a0788120c3a320b20f97656',
    origin: 'https',
    subdomainFlag: '0',
    ...
    style: {
      type: 'safari',
      iconUrl: 'https://cdn.pushcrew.com/img/logos/b16b55bf1a0788120c3a320b20f97656/b78d1828-37e5-4f9b-b553-19868c9def4a.png',
      allowTextChildWindow: '',
      offerTextChildWindow: 'Get updates and offers from Min JS by subscribing to push notifications.',
      ...
      chromeTitle: 'ct1',
      chromeSubtitle: 'ct2',
      safariTitle: 'The website “Min JS” would like to send you push notifications.',
...
*/
  (function () {
    ...
    !function (a, b) {
      ...
      function Ua(a, b, c) {
        for (var d, e = (Ra[b] || [
        ]).concat(Ra['*']), f = 0, g = e.length; g > f; f++) if (d = e[f].call(c, b, a)) return d
      }
      function Va(a, b, c) {
        var d,
        e,
      ...
      function qb(a) {
        return function (b, c) {
          ...
          if (n.isFunction(c)) for (; d = f[e++]; ) '+' === d[0] ? (d = d.slice(1) || '*', (a[d] = a[d] || [
          ]).unshift(c))  : (a[d] = a[d] || [
          ]).push(c)
        }
      }
      ...
      var t = function (a) {
        ...
        function wa(a, b, c, d, e, f) {
          ...
          ia(function (f, g, h, i) {
            ...
            if (c && c(q, r, h, i), d) for (j = va(r, n), d(j, [
            ], h, i), k = j.length; k--; ) (l = j[k]) && (r[n[k]] = !(q[n[k]] = l));
            if (f) {
              if (e || a) {
                if (e) {
                  for (j = [
                  ], k = r.length; k--; ) (l = r[k]) && j.push(q[k] = l);
                  e(null, r = [
                  ], j, i)
                }
               ...
               : function (b, c, i) {
                ...
                if (q) {
                  ...
                  if (o = [
                    ...
                    ], n = j[0] === w && j[1], m = j[0] === w && j[2], l = n && q.childNodes[n]; l = ++n && l && l[p] || (m = n = 0) || o.pop(); ) if (1 === l.nodeType && ++m && l === b) {
                      k[a] = [
                        w,
                        n,
                        m
                   ...
                   else for (; (l = ++n && l && l[p] || (m = n = 0) || o.pop()) && ((h ? l.nodeName.toLowerCase() !== r : 1 !== l.nodeType) || !++m || (s && ((l[u] || (l[u] = {
                  })) [a] = [
                    w,
                    m
                  ]), l !== b)); );
        ...
        h = ga.compile = function (a, b) {
          ...
          f = A[a + ' '];
          if (!f) {
            for (b || (b = g(a)), c = b.length; c--; ) f = xa(b[c]),
        ...
        k = {
          ...
          remove: function () {
            return h && n.each(arguments, function (a, b) {
              for (var c; (c = n.inArray(b, h, c)) > - 1; ) h.splice(c, 1),
              d && (f >= c && f--, g >= c && g--)
            }),
            this
          },
      ...
      n.event = {
        ...
        add: function (a, b, c, d, e) {
          ...
          q,
          r = L.get(a);
          if (r) for (c.handler && (f = c, c = f.handler, e = f.selector), c.guid || (c.guid = n.guid++), (i = r.events) || (i = r.events = {
          }), (g = r.handle) || (g = r.handle = function (b) {
            return typeof n !== U && n.event.triggered !== b.type ? n.event.dispatch.apply(a, arguments)  : void 0
          }), b = (b || '').match(E) || [
            ''
          ], j = b.length; j--; ) h = Y.exec(b[j]) || [
          ],
          o = q = h[1],
          p = (h[2] || '').split('.').sort(),
        ...
        dispatch: function (a) {
          ...
          if (i[0] = a, a.delegateTarget = this, !k.preDispatch || k.preDispatch.call(this, a) !== !1) {
            for (h = n.event.handlers.call(this, a, j), b = 0; (f = h[b++]) && !a.isPropagationStopped(); ) for (a.currentTarget = f.elem, c = 0; (g = f.handlers[c++]) && !a.isImmediatePropagationStopped(); ) (!a.namespace_re || a.namespace_re.test(g.namespace)) && (a.handleObj = g, a.data = g.data, e = ((n.event.special[g.origType] || {
      ...
      n.extend({
        ...
        buildFragment: function (a, b, c, d) {
          for (var e, f, g, h, i, j, k = b.createDocumentFragment(), l = [
            ...
            for (f = f || k.appendChild(b.createElement('div')), g = (ba.exec(e) || [
              '',
              ''
            ]) [1].toLowerCase(), h = ia[g] || ia._default, f.innerHTML = h[1] + e.replace(aa, '<$1></$2>') + h[2], j = h[0]; j--; ) f = f.lastChild;
      ...
      n.extend({
        ...
        style: function (a, b, c, d) {
          if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
            ...
            void 0 === c ? g && 'get' in g && void 0 !== (e = g.get(a, !1, d)) ? e : i[b] : (f = typeof c, 'string' === f && (e = Ba.exec(c)) && (c = (e[1] + 1) * e[2] + parseFloat(n.css(a, b)), f = 'number'), void (null != c && c === c && ('number' !== f || n.cssNumber[h] || (c += 'px'), k.clearCloneStyle || '' !== c || 0 !== b.indexOf('background') || (i[b] = 'inherit'), g && 'set' in g && void 0 === (c = g.set(a, c, d)) || (i[b] = c))))
          }
        },
      ...
      n.extend({
        ...
        removeAttr: function (a, b) {
          ...
          e = 0,
          f = b && b.match(E);
          if (f && 1 === a.nodeType) for (; c = f[e++]; ) d = n.propFix[c] || c,
      ...
      n.fn.extend({
        addClass: function (a) {
          ...
          ]; j > i; i++) if (c = this[i], d = 1 === c.nodeType && (c.className ? (' ' + c.className + ' ').replace(ab, ' ')  : ' ')) {
        ...
        toggleClass: function (a, b) {
          ...
          return 'boolean' == typeof b && 'string' === c ? b ? this.addClass(a)  : this.removeClass(a)  : this.each(n.isFunction(a) ? function (c) {
           ...
           : function () {
            if ('string' === c) for (var b, d = 0, e = n(this), f = a.match(E) || [
            ]; b = f[d++]; ) e.hasClass(b) ? e.removeClass(b)  : e.addClass(b);
        ...
        ajax: function (a, b) {
          ...
          v = {
            ...
            getResponseHeader: function (a) {
              ...
              if (2 === t) {
                if (!f) for (f = {
                }; b = gb.exec(e); ) f[b[1].toLowerCase()] = b[2];
                b = f[a.toLowerCase()]
              }
      ...
      'function' == typeof define && !1 && define.amd && define('jquery', [
      ], function () {
        return n
      });
      var Kb = a.jQuery,
    ...
    function ($pushcrew) {
      ...
      function retry(isDone, next) {
        ...
        id = window.setInterval(function () {
          isDone() && (window.clearInterval(id), next(is_timeout)),
          current_trial++ > max_retry && (window.clearInterval(id), is_timeout = !0, next(is_timeout))
        }, 10)
      }
      ...
      function detectPrivateMode(callback) {
        ...
        if (window.webkitRequestFileSystem) window.webkitRequestFileSystem(window.TEMPORARY, 1, function () {
          ...
          'undefined' == typeof is_private && (is_private = !1, window.localStorage.removeItem('test'))
        }
        retry(function () {
      ...
      function getBrowser() {
        ...
        return /trident/i.test(M[1]) ? (tem = /\brv[ :]+(\d+)/g.exec(ua) || [
         ...
         : (M = M[2] ? [
          ...
          '-?'
        ], null != (tem = ua.match(/version\/(\d+)/i)) && M.splice(1, 1, tem[1]), isiOS && (M[0] = 'iOS'), M[0] = M[0].toLowerCase(), {
          name: M[0],
          version: M[1]
        })
      }
      ...
      pushAPI.pushSubscription = function () {
        ...
        return {
          ...
          initialiseState: function () {
            return 'showNotification' in ServiceWorkerRegistration.prototype ? 'denied' === Notification.permission ? (pushAPI.pushSubscription.canPushBeEnabled = !1, pushAPI.pushSubscription.isUserSubscriptionDenied = !0, !1)  : 'PushManager' in window ? !0 : (pushAPI.pushSubscription.canPushBeEnabled = !1, !1)  : (pushAPI.pushSubscription.canPushBeEnabled = !1, !1)
          },
          ...
          detectBrowserType: function () {
            'safari' in window && 'pushNotification' in window.safari ? this.browserType = 'safari' : 'chrome' in window && 'serviceWorker' in navigator ? this.browserType = 'chrome' : /Firefox[\/\s](\d+\.\d+)/.test(navigator.userAgent) && 'serviceWorker' in navigator ? this.browserType = 'firefox' : (this.browserType = 'not-supported', this.canPushBeEnabled = !1)
          },
          subscribe: function () {
          ...
          unsubscribe: function () {
            ...
            return navigator.serviceWorker.ready.then(function (serviceWorkerRegistration) {
              serviceWorkerRegistration.pushManager.getSubscription().then(function (subscription) {
                subscription || (isPushEnabled = !1, promise.resolve('error')),
      ...
      pushAPI.storageUtil = function () {
        ...
        return {
          ...
          setCookie: function (name, value, exdays) {
            var d = new Date;
            d.setTime(d.getTime() + 24 * parseInt(exdays) * 60 * 60 * 1000);
        ...
        return {
          ...
          callSyncSubscription: function (data, promise, action, subscriptionId, subscriptionEndPoint) {
            ...
            var setPushSubscriptionStorage = function () {
              'unsubscribe-ui' !== action && 'unsubscribe-native' !== action && (pushAPI.storageUtil.addToStorage('wingify_push_subscription_id', subscriptionId, 10000), pushAPI.storageUtil.addToStorage('wingify_push_subscription_endpoint', subscriptionEndPoint, 10000))
            };
            $pushcrew.ajax({
              ...
              dataType: 'jsonp',
              error: function () {
                pushAPI.storageUtil.addToStorage('wingify_push_db_status', 'false', 10000),
                setPushSubscriptionStorage(),
                promise.resolve('error')
              },
              success: function (response) {
                'success' === response.status ? (response.hasOwnProperty('subscriber_id') && (pushAPI.storageUtil.addToStorage('wingify_push_subscriber_id', response.subscriber_id, 10000), pushAPI.storageUtil.addToStorage('wingify_push_db_status', 'true', 10000), pushAPI.storageUtil.addToStorage('wingify_push_subscription_status', 'subscribed', 10000)), 'unsubscribe-ui' !== action && 'unsubscribe-native' !== action || (pushAPI.storageUtil.addToStorage('wingify_push_subscription_status', 'unsubscribed', 10000), pushAPI.storageUtil.deleteFromStorage('wingify_push_subscriber_id'), pushAPI.storageUtil.deleteFromStorage('wingify_push_db_status'), pushAPI.storageUtil.deleteFromStorage('wingify_push_subscription_endpoint'), pushAPI.storageUtil.deleteFromStorage('wingify_push_subscription_id')), setPushSubscriptionStorage(), promise.resolve('success'))  : 'failure' === response.status && (setPushSubscriptionStorage(), pushAPI.storageUtil.addToStorage('wingify_push_db_status', 'false', 10000), promise.resolve('error'))
              }
            })
          },
          ...
          splitSubscriptionParameters: function (subscriptionDetails) {
            ...
            if ('error' !== subscriptionDetails && 'denied' !== subscriptionDetails) {
              ...
              } else endpointURL = 'https://android.googleapis.com/gcm/send',
              endpoint = subscriptionDetails.endpoint;
          ...
          setNewPushSubscriber: function (subscriptionDetails, sendFirstNotification) {
            ...
            return 'error' !== response && 'denied' !== response ? (this.syncSubscription(JSON.stringify(subscriptionDetails), '', '', response.subscriptionId, response.endpoint, 'insert').then(function (value) {
              pushAPI.storageUtil.addToStorage('wingify_push_subscription_status', 'subscribed', 10000),
          ...
          unsubscribeFromPushNotification: function () {
            ...
            return promise.then(function (response) {
              ...
              } else promiseInside.resolve('already-unsubscribed')
            }),
            promiseInside
          },
          ...
          getSafariDeviceToken: function (permissionData) {
            ...
            }, this.getSafariDeviceToken)  : 'denied' === permissionData.permission ? console.log('Safari Subscription Status - Denied')  : 'granted' === permissionData.permission && console.log('Safari Subscription Status - Granted')
          }
        }
      }();
      var APIReadyState = {
      ...
      function () {
        ...
        _pushcrew.executeFailureQueue = function (reason) {
          for (var i = 0; i < apiFailureQueue.length; i++) apiFailureQueue[i](reason);
          apiFailureQueue = [
          ]
        },
        ...
        _pushcrew.triggerOptOut = function () {
          return pushcrew.isAPIReady === APIReadyState.UNINITIALIZED ? void _internalq.push(['triggerOptOut'])  : void _pushcrew.showModal({
          }, 4)
        },
        _pushcrew.addSubscriberToSegment = function (segment, callback) {
          ...
          subscriptionId,
          returnValue;
          if (pushcrew.isAPIReady === APIReadyState.UNINITIALIZED) return void _internalq.push(['addSubscriberToSegment',
          segment,
          callback]);
          if (subscriberId = storageUtil.getFromStorage('wingify_push_subscriber_id'), subscriptionId = storageUtil.getFromStorage('wingify_push_subscription_id'), segment.length >= 30 && 0 !== segment.length || !_utils.validString(segment)) returnValue = !1;
        ...
        _pushcrew.removeSubscriberFromSegment = function (segment, callback) {
          ...
          if (segment.length >= 30 && 0 !== segment.length || !_utils.validString(segment)) returnValue = !1;
           else if (subscriberId) {
            var img = new Image,
            count = 0;
        ...
        _pushcrew.triggerOptInExecute = function (triggerBoxObject) {
          ...
          triggerBox.modal ? (isModal = !0, 'string' == typeof triggerBox.modal.text && (textArray.SUBSCRIBE = triggerBox.modal.text, textArray.ALREADYSUBSCRIBED = 'You are already subscribed to get instant alerts from us. Keep an eye on your browser for new notifications from us.', textArray.BLOCKED = 'Uh-oh! You seem to have blocked the notifications last time you came on our website. To see how to subscribe', triggerBox.modal.text = textArray))  : isModal = !1;
          var subscriberSegment = triggerBox.subscriberSegment || '',
          isUserSubscribed = pushcrew.subscriberId;
          - 1 === isUserSubscribed && isModal ? _pushcrew.showModal(triggerBox.modal, 3)  : isUserSubscribed === !1 ? (isModal && _pushcrew.showModal(triggerBox.modal, 2), _pushcrew.subscribeToPush(subscriberSegment, triggerBox.modal))  : isUserSubscribed && isModal && _pushcrew.showModal(triggerBox.modal, 1)
        },
        _pushcrew.showModal = function (modal, category) {
          ...
          modal.blackenBackground ? $pushcrew('.pushcrew-modal-overlay').fadeTo(500, 0.8)  : $pushcrew('.pushcrew-modal-overlay').fadeTo(500, 0);
        ...
        _pushcrew.subscribeToPush = function (segmentName, modal) {
          ...
          subscribePromise.then(function (newSubscription) {
            ...
            })  : (initAPIValues(), pushcrew.subscriptionFailureCallback && ('denied' === response ? pushcrew.subscriptionFailureCallback({
              status: 'BLOCKED',
      ...
      $pushcrew(document).ready(function () {
        ...
        isChromeSupported || isFirefoxSupported ? (detectPrivateMode(function (is_private) {
          is_private ? (_pushcrew.apiFailureReasons = {
          ...
          }, pushcrew.isAPIReady = APIReadyState.FAILED, _pushcrew.executeFailureQueue(_pushcrew.apiFailureReasons))  : (timestamp = Date.now(), $pushcrew('head').append('<link rel="manifest" href="' + pushcrewConfig.manifestUrl + '?t=' + timestamp + '">'), link.type = 'text/css', link.rel = 'stylesheet', link.href = cssUrl, prefetchImagesList = [
            'https://pushcrew.com/assets/images/pushcrew-white.png',
            pushcrewConfig.style.iconUrl
          ], preload(prefetchImagesList), head.appendChild(link), link.onload = function () {
            if (notificationClickBranding(), storageUtil.initialiseState(pushcrewConfig.domainForStorageUtil), manageSubscription.customerHash = pushcrewConfig.hash, pushSubscription.detectBrowserType(), secondsTrigger = pushcrewConfig.secondsTrigger - (Date.now() - pushcrew._currentTime) / 1000, secondsTrigger = secondsTrigger > 0 ? secondsTrigger : 0, 'chrome' === pushSubscription.browserType) pushSubscription.serviceWorkerPath = pushcrewConfig.swPath,
            ...
            promise.then(function (response) {
              response === !1 && pushSubscription.canPushBeEnabled === !0 ? manageSubscription.syncUnsubscribedUsers().then(function () {
                return 'unsubscribed' === pushAPI.storageUtil.getFromStorage('wingify_push_subscription_status') && 'granted' === Notification.permission ? (initAPIValues(), pushcrew.isAPIReady = APIReadyState.READY, void executeInternalQueue())  : (initAPIValues(), pushcrew.isAPIReady = APIReadyState.READY, executeInternalQueue(), void (pushcrew.noTrigger || 0 === pushcrewConfig.triggerAutomaticOptIn || setTimeout(function () {
                  _pushcrew.triggerOptInExecute(_pushcrew.triggerBox)
                }, 1000 * secondsTrigger)))
              })  : response !== !1 && pushSubscription.canPushBeEnabled === !0 ? (manageSubscription.doesUserResponseExists = !0, manageSubscription.updateSubscription(response).then(function () {
                initAPIValues(),
              ...
              if (pushSubscription.websiteSafariPushId = pushcrewConfig.safariWebsitePushId, pushcrew.noTrigger || 0 === pushcrewConfig.triggerAutomaticOptIn) return;
              setTimeout(function () {
                safartiInit()
              }, 1000 * secondsTrigger)
        ...
        }, pushcrew.isAPIReady = APIReadyState.FAILED, void _pushcrew.executeFailureQueue(_pushcrew.apiFailureReasons))
      })
    }(jQuery.noConflict(!0));
  }) ();
}) ();
